...
class MyNode(Node):
    ...
    def demo_opt(self):
        ...
        t3 = t1 - t2    # 没有相加，没有意义，只能相减  比如计算时间差 2024年 - 2020年 = 4年  相加无意义，2024+2023 = 4047（无意义）
        t4 = t1 + du1
        t5 = t1 - du1
        self.get_logger().info("t3 = %d" % t3.nanoseconds) # 5
        self.get_logger().info("t4 = %d" % t4.nanoseconds) # 27
        self.get_logger().info("t5 = %d" % t5.nanoseconds) # 13
